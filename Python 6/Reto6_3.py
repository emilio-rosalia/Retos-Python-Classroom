...
while palabra_a_buscar.capitalize != 'NO': # Usamos capizalice para aceptar como válida las palabras No, NO, no y nO para detener la búsqueda
    ...
    palabra_a_buscar = input('Dígame la plabra a buscar (escribe no para deje de buscar): ')
